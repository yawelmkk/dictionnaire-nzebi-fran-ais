...
export const getAudioFilePath = (
  ...
  // Don't sanitize - keep the original word as is, including accents
  // The files are named with their original spelling
  return `${DEFAULT_AUDIO_CONFIG.basePath}/${wordId.toLowerCase()}.${format}`;
};
