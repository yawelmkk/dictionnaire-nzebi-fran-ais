...
// In GitHub Pages deployments, the app is served from a subpath (e.g. /repo-name/).
// The service worker scope will match that base path, so we can use it to build URLs.
